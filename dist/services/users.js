...
var UserService = /** @class */ (function (_super) {
    ...
    function UserService(entityManager) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.entityManager.find(entities_1.User)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, {
                                result: result,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        userExists = (_a.sent()) > 0;
                        if (userExists === false) {
                            throw new utils_1.CustomError("User not found", http_status_codes_1.StatusCodes.NOT_FOUND);
                        }
